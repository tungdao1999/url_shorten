...
namespace UrlShortenAPI.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequest request)
        {
            ...
            if (userExists != null)
            {
                BaseResponse value = new BaseResponse { Status = "Error", Message = "User already exists!" };
            ...
            if (!result.Succeeded)
                return StatusCode(StatusCodes.Status500InternalServerError, new BaseResponse { Status = "Error", Message = "User creation failed! Please check user details and try again." });
